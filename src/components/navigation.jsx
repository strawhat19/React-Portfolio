...
function Navigation({ currentPage, changeCurrentPage }) {
    ...
    <nav className={currentPage}>
        ...
        <a onClick={() => changeCurrentPage('contact')} class="navLink hoverLine" id="contact" title="Contact"><i class="fas fa-paper-plane"></i> | Contact</a>
        <a onClick={() => changeCurrentPage('resume')} class="navLink hoverLine" id="resume" title="Resume"><i class="fas fa-file-contract"></i> | Resume</a>
    </nav>
    );
}
